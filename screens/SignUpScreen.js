...
const SignUpScreen = () => {
 ...
 try {
    ...
    await signInWithCredential(auth, credential);  // Updated this line
    Alert.alert('Success', 'Mobile number verified successfully');
    navigation.navigate('AadharVerification', { name, mobile });
  } catch (error) {
    console.error('Error verifying OTP:', error);
...
//     try {
//       setIsLoading(true);
//       // For now, let's simulate OTP sending for testing
//       // You can implement actual Firebase phone auth later
//       setTimeout(() => {
